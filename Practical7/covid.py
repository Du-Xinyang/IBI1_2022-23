...
# This is the code for showing the second column from every 100th row from the first 1000 rows (inclusive)
...
# Comupute the mean number of new cases and new deaths on 31 March 2020
